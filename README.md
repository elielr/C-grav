...
:--------------------------------------------------------------------------------------------------------------------------:|:-------------------------------------------------------------------------------:
![Eventually crashes in a planet](https://github.com/elielr/C-grav/blob/main/figs/readme/0a-fintraj.gif?raw=true)  |  ![This stable trajectory densely fills the area between two smooth convex curves around the planets](https://github.com/elielr/C-grav/blob/main/figs/readme/0b-inftraj.gif?raw=true)
...
![Some possible initial speed vectors for a given configuration and the resulting trajectories](https://github.com/elielr/C-grav/blob/main/figs/readme/1-examples.png?raw=true)
...
![Linesearch initial configuration, starting point = 0, other end of the line = 1](https://github.com/elielr/C-grav/blob/main/figs/readme/5-line.png?raw=true)
...
![Flight time over the line section with different p-adic samplings](https://github.com/elielr/C-grav/blob/main/figs/readme/6-lineresults.png?raw=true)
...
The initial segment at level 0 is set as the bottom left and top right corners of the frame.
...
![C-Grav plot4 example: initial configuration - crash map - trajectory - score map](https://github.com/elielr/C-grav/blob/main/figs/readme/8-fractal(3,16).png?raw=true)

### Fractal Monte Carlo

Based on Delaunay triangulation and Voronoï diagram.\
No public version.

## Conclusion

In the end, this problem boils down to an exploration vs exploitation sampling dilemma. 

A very narrow sampling such as the dichotomic linesearch locks on deeply on a small region of interest will either provide a long lasting highly optimized trajectory, grazing the edges of both the frame and the planets, or get stuck in a bad region (it usually gets beaten by one or more of the p-adic line samplings), the same goes for a fractal grid-search allowing a high maximum level.
